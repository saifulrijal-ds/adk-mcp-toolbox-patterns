...
def main():
    ...
    parser.add_argument("--top_n", default="10")
    parsed = parser.parse_args()
    call_tool("tool_visit_collector_ranking", {"report_start": parsed.report_start, "report_end": parsed.report_end, "top_n": parsed.top_n})
